...
c.MarkdownExporter.template_path = ['{{BASE_PATH}}'] # point this to your jekyll template file
...
if f:
    ...
    c.FilesWriter.build_directory = '{{ BASE_PATH }}' # point this to your build directory
